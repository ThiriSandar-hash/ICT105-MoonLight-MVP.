...
|---|---|---|---|---|
| Budget Tracker | Expense management| Students and young professionals | Notebooks, Spreadsheets, Rely on memory | Web App, Mobile App |
| Study Planner | Manage schedules | Students | Paper planners, Calendars, Reminder applications | App with scheduling features |
| Campus event finder | Missing events | Students | Posters, Word-of-mouth communication | Event management system |
